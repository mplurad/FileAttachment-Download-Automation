...
namespace High_Radius_Invoice_Download_Automation
{
    ...
    /// </summary>
    class PublicAppUsingUsernamePassword
    {
        /// <summary>
        ...
        public async Task<AuthenticationResult> GetTokenForWebApiUsingUsernamePasswordAsync(IEnumerable<string> scopes, string username, SecureString password)
        {
